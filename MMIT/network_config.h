...
// Backend API configuration (FastAPI running on Raspberry Pi)
// When running on Pi, use 127.0.0.1. When testing from laptop, use Pi's IP
#define BACKEND_API_HOST    "127.0.0.1"  // Or "192.168.1.XXX" for Pi IP
